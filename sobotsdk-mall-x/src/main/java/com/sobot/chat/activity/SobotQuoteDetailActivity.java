    ...
    protected void initData() {
        if (appointMessage != null) {
            ...
            if (msgType == 0) {
                ...
                try {
                    int pictureWidth = getResources().getDimensionPixelSize(R.dimen.sobot_rich_msg_picture_width_dp);
                    int pictureHeight = getResources().getDimensionPixelSize(R.dimen.sobot_rich_msg_picture_height_dp2);
                    if (pictureWidth == 0) {
                ...
                try {
                    ...
                    if (contentJsonObject.has("url") && !TextUtils.isEmpty(contentJsonObject.optString("url"))) {
                        if (contentJsonObject.has("voiceType") && contentJsonObject.optInt("voiceType") == 1) {
                            ...
                            sobot_file_name.setTextColor(ContextCompat.getColor(getSobotBaseActivity(), R.color.sobot_common_gray1));
                            sobot_file_size.setTextColor(ContextCompat.getColor(getSobotBaseActivity(), R.color.sobot_common_gray1));
...
//                                                            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ScreenUtils.dip2px(this, msgCardWidth), ViewGroup.LayoutParams.WRAP_CONTENT);
//                                                            layoutParams.setMargins(0, ScreenUtils.dip2px(this, 10), 0, 0);
//                                                            view.setLayoutParams(layoutParams);
                                                            TextView tv_title = view.findViewById(R.id.tv_title);
                                                            tv_title.setTextColor(ContextCompat.getColor(getSobotBaseActivity(), R.color.sobot_common_gray1));
                                                            ...
                                                            if (richListModel.getSobotLink() != null) {
                                                                ...
                                                                tv_des.setTextColor(ContextCompat.getColor(getSobotBaseActivity(), R.color.sobot_common_gray1));
...
//                                                    LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ScreenUtils.dip2px(this, msgCardWidth), ViewGroup.LayoutParams.WRAP_CONTENT);
//                                                    layoutParams.setMargins(0, ScreenUtils.dip2px(this, 10),ScreenUtils.dip2px(this, 6), 0);
//                                                    view.setLayoutParams(layoutParams);
                                                    sobot_rich_ll.addView(view);
                                                    view.setOnClickListener(new View.OnClickListener() {
                                                        @Override
                            ...
                            if (contentJsonObject.has("msg") && !TextUtils.isEmpty(contentJsonObject.optString("msg"))) {
                                try {
                                    ...
                                    tv_title.setTextColor(ContextCompat.getColor(getSobotBaseActivity(), R.color.sobot_common_gray1));
                                    tv_desc.setTextColor(ContextCompat.getColor(getSobotBaseActivity(), R.color.sobot_common_gray1));
                                    if (model != null) {
