...
public class SobotPostMsgFragment extends SobotBaseFragment implements View.OnClickListener, ISobotCusField {
    ...
    protected void initView(View rootView) {
        ...
        sobot_frist_line = rootView.findViewById(R.id.sobot_frist_line);
        sobot_post_title_line = rootView.findViewById(R.id.sobot_post_title_line);
        sobot_post_question_line = rootView.findViewById(R.id.sobot_post_question_line);
        sobot_post_customer_line = rootView.findViewById(R.id.sobot_post_customer_line);
        sobot_post_title_sec_line = rootView.findViewById(R.id.sobot_post_title_sec_line);
        sobot_post_question_sec_line = rootView.findViewById(R.id.sobot_post_question_sec_line);
        sobot_post_customer_sec_line = rootView.findViewById(R.id.sobot_post_customer_sec_line);
        sobot_phone_line = rootView.findViewById(R.id.sobot_phone_line);
        ...
        String test = getContext().getResources().getString(R.string.sobot_problem_types) + "<font color='#f9676f'>&nbsp;*</font>";
        ...
        email_hint_input_label.setHint(R.string.sobot_please_input);
        title_hint_input_lable = (TextView) rootView.findViewById(R.id.sobot_post_title_lable_hint);
        title_hint_input_lable.setHint(R.string.sobot_please_input);
        sobot_post_phone_rl = (RelativeLayout) rootView.findViewById(R.id.sobot_post_phone_rl);
        phone_hint_input_label = (TextView) rootView.findViewById(R.id.sobot_post_phone_lable_hint);
        phone_hint_input_label.setHint(R.string.sobot_please_input);
        ...
        if (mConfig.isEmailShowFlag()) {
            ...
            sobot_post_email_rl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sobot_post_email_lable.setTextColor(ContextCompat.getColor(getSobotActivity(), R.color.sobot_common_gray2));
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    if (TextUtils.isEmpty(sobot_post_email.getText().toString().trim())) {
                        ...
                        sobot_post_email_lable.setTextColor(ContextCompat.getColor(getSobotActivity(), R.color.sobot_common_gray1));
        ...
        if (mConfig.isTelShowFlag()) {
            ...
            sobot_post_phone_rl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sobot_post_phone_lable.setTextColor(ContextCompat.getColor(getSobotActivity(), R.color.sobot_common_gray2));
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    if (TextUtils.isEmpty(sobot_post_phone.getText().toString().trim())) {
                        ...
                        sobot_post_phone_lable.setTextColor(ContextCompat.getColor(getSobotActivity(), R.color.sobot_common_gray1));
        ...
        if (mConfig.isTicketTitleShowFlag()) {
            ...
            sobot_post_title_rl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sobot_post_title_lable.setTextColor(ContextCompat.getColor(getSobotActivity(), R.color.sobot_common_gray2));
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    if (TextUtils.isEmpty(sobot_post_title.getText().toString().trim())) {
                        ...
                        sobot_post_title_lable.setTextColor(ContextCompat.getColor(getSobotActivity(), R.color.sobot_common_gray1));
    ...
    private void checkSubmit() {
        ...
        if (mConfig.isTelShowFlag()) {
            if (mConfig.isTelFlag()) {
                if (TextUtils.isEmpty(sobot_post_phone.getText().toString().trim())) {
                    showHint(getContext().getResources().getString(R.string.sobot_phone_no_empty));
                    return;
                }
...
//        });
    ...
    private void editTextSetHint() {
        ...
        if (mConfig.isEmailFlag()) {
            sobot_post_email_lable.setText(Html.fromHtml(getContext().getResources().getString(R.string.sobot_email) + mustFill));
        } else {
            sobot_post_email_lable.setText(Html.fromHtml(getContext().getResources().getString(R.string.sobot_email)));
        }

        if (mConfig.isTelFlag()) {
            sobot_post_phone_lable.setText(Html.fromHtml(getContext().getResources().getString(R.string.sobot_phone) + mustFill));
        } else {
            sobot_post_phone_lable.setText(Html.fromHtml(getContext().getResources().getString(R.string.sobot_phone)));
        }
        if (mConfig.isTicketTitleShowFlag()) {
            sobot_post_title_lable.setText(Html.fromHtml(getContext().getResources().getString(R.string.sobot_title) + mustFill));
        }
                ...
                case ZhiChiConstant.work_order_list_display_type_category:
                    if (!TextUtils.isEmpty(data.getStringExtra("category_typeId"))) {
                        ...
                        if (!TextUtils.isEmpty(typeName)) {
                            ...
                            sobot_post_question_lable.setTextColor(ContextCompat.getColor(getSobotActivity(), R.color.sobot_common_gray2));
