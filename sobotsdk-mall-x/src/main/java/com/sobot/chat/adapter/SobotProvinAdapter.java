...
//            int color = ThemeUtils.getThemeColor(context);
//            categoryIshave.setBackground(ThemeUtils.applyColorToDrawable(context.getResources().getDrawable(R.drawable.sobot_icon_completed), color));
        ...
        void bindData(SobotProvinInfo.SobotProvinceModel data) {
            ...
            if (data.nodeFlag) {
                ...
                categoryIshave.setBackgroundResource(R.drawable.sobot_right_arrow_icon);
            } else {
            ...
            if (data.isChecked) {
                categoryIshave.setVisibility(View.VISIBLE);
                categoryIshave.setBackgroundResource(R.drawable.sobot_work_order_selected_mark);
            }
