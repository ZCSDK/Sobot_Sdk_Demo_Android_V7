...
//        }
//    }
    public SobotGoodsAdapter(Context context, List<SobotChatCustomGoods> list,int cardStyle, boolean isRight, SobotMsgAdapter.SobotMsgCallBack msgCallBack, boolean isHistory, boolean isOne) {
        this.context = context;
        itemWidth = ScreenUtils.getScreenWidth((Activity) context) * 60 / 100 + ScreenUtils.dip2px(context, 36);
        changeThemeColor = ThemeUtils.isChangedThemeColor(context);
        if (changeThemeColor) {
