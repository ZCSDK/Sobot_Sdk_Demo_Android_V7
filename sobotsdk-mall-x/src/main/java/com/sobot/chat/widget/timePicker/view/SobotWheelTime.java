...
public class SobotWheelTime {
    ...
    public SobotWheelTime(View view, boolean[] type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
     ...
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
        ...
        if (startYear == endYear && startMonth == endMonth) {
            if (list_big.contains(String.valueOf(month + 1))) {
                ...
                wv_day.setAdapter(new SobotNumericWheelAdapter(startDay, endDay));
            ...
            if (list_big.contains(String.valueOf(month + 1))) {
                ...
                wv_day.setAdapter(new SobotNumericWheelAdapter(startDay, 31));
            } else if (list_little.contains(String.valueOf(month + 1))) {

                wv_day.setAdapter(new SobotNumericWheelAdapter(startDay, 30));
            } else {
                // 闰年
                if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) {

                    wv_day.setAdapter(new SobotNumericWheelAdapter(startDay, 29));
                } else {

                    wv_day.setAdapter(new SobotNumericWheelAdapter(startDay, 28));
                }
            }
            wv_day.setCurrentItem(day - startDay);
            ...
            if (list_big.contains(String.valueOf(month + 1))) {
                ...
                wv_day.setAdapter(new SobotNumericWheelAdapter(1, endDay));
            } else if (list_little.contains(String.valueOf(month + 1))) {
                if (endDay > 30) {
                    endDay = 30;
                }
            ...
            if (list_big.contains(String.valueOf(month + 1))) {
                ...
                wv_day.setAdapter(new SobotNumericWheelAdapter(1, 31));
            } else if (list_little.contains(String.valueOf(month + 1))) {

                wv_day.setAdapter(new SobotNumericWheelAdapter(1, 30));
            } else {
                // 闰年
                if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) {

                    wv_day.setAdapter(new SobotNumericWheelAdapter(1, 29));
                } else {

                    wv_day.setAdapter(new SobotNumericWheelAdapter(1, 28));
                }
            }
            wv_day.setCurrentItem(day - 1);
        }
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
       ...
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        ...
        // 添加"年"监听
        SobotOnItemSelectedListener wheelListener_year = new SobotOnItemSelectedListener() {
            @Override
        ...
        // 添加"月"监听
        SobotOnItemSelectedListener wheelListener_month = new SobotOnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
    ...
    private void setReDay(int year_num, int monthNum, int startD, int endD, List<String> list_big, List<String> list_little) {
        ...
        if (list_big
            ...
            wv_day.setAdapter(new SobotNumericWheelAdapter(startD, endD));
            maxItem = endD;
