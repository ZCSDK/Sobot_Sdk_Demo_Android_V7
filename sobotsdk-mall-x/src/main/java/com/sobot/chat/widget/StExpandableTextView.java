...
//        mTv.setText(text);
        if (TextUtils.isEmpty(text)) {
            ...
            try {
                ...
                HtmlTools.getInstance(getContext()).setRichText(mTv, text.toString(), color, linkBottomLine);
            } catch (Exception e) {
                HtmlTools.getInstance(getContext()).setRichText(mTv, text.toString(), R.color.sobot_announcement_link_color, linkBottomLine);
            }
        }
...
//        mMaxCollapsedLines = MAX_COLLAPSED_LINES;
        ...
        mExpandStrResId = typedArray.getResourceId(R.styleable.sobot_ExpandableTextView_sobot_ExpandStrResId, R.drawable.sobot_icon_triangle_down);
        mCollapseStrResId = typedArray.getResourceId(R.styleable.sobot_ExpandableTextView_sobot_CollapseStrResId, R.drawable.sobot_icon_triangle_up);
...
//        mTv.setOnClickListener(this);
        ...
        mImageView = findViewById(R.id.expand_image);
        mTextBtn = findViewById(R.id.expand_text_btn);
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
