...
public class SobotTimePickerView extends SobotBasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.sobot_pickerview_time, contentContainer);
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.sobot_btn_submit) : Str_Submit);
...
//            btnCancel.setTextSize(Size_Submit_Cancel);
            ...
            customListener.customLayout(LayoutInflater.from(context).inflate(getIdByName(context,"layout",layoutRes), contentContainer));
        }
        // 时间转轮 自定义控件
