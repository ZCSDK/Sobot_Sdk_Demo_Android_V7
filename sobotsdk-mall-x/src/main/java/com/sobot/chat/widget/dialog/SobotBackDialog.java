...
public class SobotBackDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sobot_back_popup);
        initView();
    }
    ...
    private void initView() {
        ...
        sobot_btn_cancle_conversation.setText(R.string.sobot_cancle_conversation);
        sobot_btn_temporary_leave = (Button) findViewById(R.id.sobot_btn_temporary_leave);
        sobot_btn_temporary_leave.setText(R.string.sobot_temporary_leave);
        ...
        sobot_tv_will_end_conversation.setText(R.string.sobot_will_end_conversation);
