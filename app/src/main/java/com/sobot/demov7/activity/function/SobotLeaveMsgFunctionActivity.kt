...
import com.sobot.demov7.util.SobotSPUtil.getBooleanData
import com.sobot.demov7.util.SobotSPUtil.getObject
import com.sobot.demov7.util.SobotSPUtil.saveBooleanData
import com.sobot.demov7.util.SobotSPUtil.saveObject

class SobotLeaveMsgFunctionActivity : SobotDemoBaseActivity(), View.OnClickListener {
    ...
    override val contentViewResId: Int
        get() = R.layout.sobot_demo_leavemsg_func_activity
