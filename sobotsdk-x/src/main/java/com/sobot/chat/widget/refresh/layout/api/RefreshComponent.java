...
public interface RefreshComponent extends OnStateChangedListener {
     ...
     */
    @RestrictTo({LIBRARY,LIBRARY_GROUP,SUBCLASSES})
    void onReleased(@NonNull com.sobot.chat.widget.refresh.layout.api.RefreshLayout refreshLayout, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY,LIBRARY_GROUP,SUBCLASSES})
    void onStartAnimator(@NonNull com.sobot.chat.widget.refresh.layout.api.RefreshLayout refreshLayout, int height, int maxDragHeight);
