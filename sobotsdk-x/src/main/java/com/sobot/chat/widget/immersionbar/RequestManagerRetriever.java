...
class RequestManagerRetriever implements Handler.Callback {
    ...
    private final String mTag = SobotImmersionBar.class.getName() + ".";
     ...
     */
    public SobotImmersionBar get(Activity activity, boolean isOnly) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar get(Fragment fragment, boolean isOnly) {
    ...
    public SobotImmersionBar get(android.app.Fragment fragment, boolean isOnly) {
        checkNotNull(fragment, "fragment is null");
        checkNotNull(fragment.getActivity(), "fragment.getActivity() is null");
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar get(Activity activity, Dialog dialog, boolean isOnly) {
        checkNotNull(activity, "activity is null");
