package com.sobot.chat.widget.refresh.layout.api;
...
public interface RefreshLayout {
     ...
     * @return RefreshLayout
     */
    RefreshLayout setRefreshFooter(@NonNull com.sobot.chat.widget.refresh.layout.api.RefreshFooter footer);
     ...
     * @return RefreshLayout
     */
    RefreshLayout setRefreshFooter(@NonNull com.sobot.chat.widget.refresh.layout.api.RefreshFooter footer, int width, int height);
     ...
     * @return RefreshLayout
     */
    RefreshLayout setRefreshHeader(@NonNull com.sobot.chat.widget.refresh.layout.api.RefreshHeader header);
     ...
     * @return RefreshLayout
     */
    RefreshLayout setRefreshHeader(@NonNull com.sobot.chat.widget.refresh.layout.api.RefreshHeader header, int width, int height);
     ...
     * Recommended {@link com.sobot.chat.widget.refresh.layout.simple.SimpleMultiListener}
     * 设置多功能监听器
     * 建议使用 {@link com.sobot.chat.widget.refresh.layout.simple.SimpleMultiListener}
     ...
     * Recommended {@link com.sobot.chat.widget.refresh.layout.simple.SimpleBoundaryDecider}
     * 设置滚动边界判断器
     * 建议使用 {@link com.sobot.chat.widget.refresh.layout.simple.SimpleBoundaryDecider}
