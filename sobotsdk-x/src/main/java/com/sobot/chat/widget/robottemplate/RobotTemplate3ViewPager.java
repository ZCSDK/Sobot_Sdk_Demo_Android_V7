...
//多轮模板1 ViewPager
public class RobotTemplate3ViewPager extends ViewPager {
    private SobotRobotTemplate3PageAdater adapter;
    private ZhiChiMessageBase message;

    public RobotTemplate3ViewPager(Context context) {
        super(context);
        init();
    }

    public RobotTemplate3ViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
//        setOffscreenPageLimit(2);
    ...
    public void setTemplatePageAdater(SobotRobotTemplate3PageAdater adapter, ZhiChiMessageBase message) {
