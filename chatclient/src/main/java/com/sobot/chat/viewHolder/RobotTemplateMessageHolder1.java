...
import com.sobot.chat.adapter.SobotRobotTemplate1PageAdater;
...
public class RobotTemplateMessageHolder1 extends MsgHolderBase {
    ...
    private RobotTemplate1ViewPager pvTemplateFirst;
    private SobotRobotTemplate1PageAdater templatePageAdater;
    ...
    public RobotTemplateMessageHolder1(Context context, View convertView) {
        ...
        pvTemplateFirst = convertView.findViewById(R.id.pv_template_first);
    ...
    public void bindData(final Context context, ZhiChiMessageBase message) {
        ...
        if (message.getAnswer() != null && message.getAnswer().getMultiDiaRespInfo() != null) {
            ...
            if ("000000".equals(multiDiaRespInfo.getRetCode())) {
                ...
                if (interfaceRetList != null && !interfaceRetList.isEmpty()) {
                    ...
                    pvTemplateFirst.setVisibility(View.VISIBLE);
                } else {
        ...
        pvTemplateFirst.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                pvTemplateFirst.updateMessageSelectItem(i);
                setCountText();
                updatePreAndLastUI();
            }
        ...
        llPreviousPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pvTemplateFirst.selectPreviousPage();
                setCountText();
                updatePreAndLastUI();
            }
        });
        llLastPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pvTemplateFirst.selectLastPage();
                setCountText();
                updatePreAndLastUI();
            }
        });
    ...
    private void setCountText() {
        if (tvCusPageCount != null && pvTemplateFirst != null) {
            int currentPage = pvTemplateFirst.getCurrentItem() + 1;
            int totalPages = 0;
    ...
    public void updatePreAndLastUI() {
        if (pvTemplateFirst.isFirstPage()) {
            ivPreviousPage.setAlpha(0.3f);
        } else {
            ivPreviousPage.setAlpha(1f);
        }
        if (pvTemplateFirst.isLastPage()) {
