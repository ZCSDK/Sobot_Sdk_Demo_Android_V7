...
public class SobotUploadFileAdapter extends RecyclerView.Adapter<SobotUploadFileAdapter.ViewHolder> {
    ...
    private List<SobotFileModel> arrayList;
    private Listener clickListener;
    private boolean isEdit = false;
    private boolean isReply = false;

    public SobotUploadFileAdapter(Context context, List<SobotFileModel> arrayList, boolean isEdit, Listener clickListener) {
