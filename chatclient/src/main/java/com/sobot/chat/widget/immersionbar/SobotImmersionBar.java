package com.sobot.chat.widget.immersionbar;

import static com.sobot.chat.widget.immersionbar.Constants.FLAG_FITS_DEFAULT;
import static com.sobot.chat.widget.immersionbar.Constants.FLAG_FITS_STATUS;
import static com.sobot.chat.widget.immersionbar.Constants.FLAG_FITS_SYSTEM_WINDOWS;
import static com.sobot.chat.widget.immersionbar.Constants.FLAG_FITS_TITLE;
import static com.sobot.chat.widget.immersionbar.Constants.FLAG_FITS_TITLE_MARGIN_TOP;
import static com.sobot.chat.widget.immersionbar.Constants.IMMERSION_BOUNDARY_COLOR;
import static com.sobot.chat.widget.immersionbar.Constants.IMMERSION_NAVIGATION_BAR_DARK_MIUI;
import static com.sobot.chat.widget.immersionbar.Constants.IMMERSION_NAVIGATION_BAR_VIEW_ID;
import static com.sobot.chat.widget.immersionbar.Constants.IMMERSION_STATUS_BAR_DARK_MIUI;
import static com.sobot.chat.widget.immersionbar.Constants.IMMERSION_STATUS_BAR_VIEW_ID;
 ...
 * @date 2017 /05/09
 */
public final class SobotImmersionBar implements ImmersionCallback {
    ...
    private SobotImmersionBar mParentBar;
     ...
     */
    public static SobotImmersionBar with(@NonNull Activity activity) {
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull Activity activity, boolean isOnly) {
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull Fragment fragment) {
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull Fragment fragment, boolean isOnly) {
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull android.app.Fragment fragment) {
        return getRetriever().get(fragment, false);
    }
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull android.app.Fragment fragment, boolean isOnly) {
        return getRetriever().get(fragment, isOnly);
    }
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull DialogFragment dialogFragment) {
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull DialogFragment dialogFragment, boolean isOnly) {
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull android.app.DialogFragment dialogFragment) {
        return getRetriever().get(dialogFragment, false);
    }
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull android.app.DialogFragment dialogFragment, boolean isOnly) {
        return getRetriever().get(dialogFragment, isOnly);
    }
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull Activity activity, @NonNull Dialog dialog) {
     ...
     * @return the immersion bar
     */
    public static SobotImmersionBar with(@NonNull Activity activity, @NonNull Dialog dialog, boolean isOnly) {
     ...
     * @param activity the activity
     */
    SobotImmersionBar(Activity activity) {
        mActivity = activity;
     ...
     * @param fragment the fragment
     */
    SobotImmersionBar(Fragment fragment) {
        mIsFragment = true;
     ...
     * @param fragment the fragment
     */
    SobotImmersionBar(android.app.Fragment fragment) {
        mIsFragment = true;
        mActivity = fragment.getActivity();
        mFragment = fragment;
        checkInitWithActivity();
     ...
     * @param dialogFragment the dialog fragment
     */
    SobotImmersionBar(DialogFragment dialogFragment) {
        mIsDialog = true;
     ...
     * @param dialogFragment the dialog fragment
     */
    SobotImmersionBar(android.app.DialogFragment dialogFragment) {
        mIsDialog = true;
        mIsDialogFragment = true;
        mActivity = dialogFragment.getActivity();
     ...
     * @param dialog   the dialog
     */
    SobotImmersionBar(Activity activity, Dialog dialog) {
        mIsDialog = true;
        mActivity = activity;
        mDialog = dialog;
        checkInitWithActivity();
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar transparentStatusBar() {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar transparentNavigationBar() {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar transparentBar() {
        mBarParams.statusBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColor = Color.TRANSPARENT;
        mBarParams.fullScreen = true;
        return this;
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarColor(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarColor(String statusBarColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarColorInt(@ColorInt int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarColor(@ColorRes int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarColor(String navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarColorInt(@ColorInt int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColor(@ColorRes int barColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColor(String barColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColor(String barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColorInt(@ColorInt int barColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColorInt(@ColorInt int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarColor = barColor;
        mBarParams.navigationBarColor = barColor;
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarColorTransform(@ColorRes int statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarColorTransform(String statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarColorTransformInt(@ColorInt int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = statusBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarColorTransform(String navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarColorTransformInt(@ColorInt int navigationBarColorTransform) {
        mBarParams.navigationBarColorTransform = navigationBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColorTransform(@ColorRes int barColorTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColorTransform(String barColorTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barColorTransformInt(@ColorInt int barColorTransform) {
        mBarParams.statusBarColorTransform = barColorTransform;
        mBarParams.navigationBarColorTransform = barColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar addViewSupportTransformColor(View view) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar addViewSupportTransformColor(View view, String viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar addViewSupportTransformColor(View view, String viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorAfterTransform) {
        if (view == null) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar viewAlpha(@FloatRange(from = 0f, to = 1f) float viewAlpha) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar removeSupportView(View view) {
        if (view == null) {
            throw new IllegalArgumentException("View参数不能为空");
        }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar removeSupportAllView() {
        if (mBarParams.viewMap.size() != 0) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar fullScreen(boolean isFullScreen) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarAlpha(@FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarAlpha(@FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        mBarParams.navigationBarAlpha = navigationAlpha;
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barAlpha(@FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarAlpha = barAlpha;
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar autoDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar autoDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar autoStatusBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar autoStatusBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoStatusBarDarkModeEnable = isEnable;
        mBarParams.autoStatusBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar autoNavigationBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar autoNavigationBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoNavigationBarDarkModeEnable = isEnable;
        mBarParams.autoNavigationBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarDarkFont(boolean isDarkFont) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarDarkFont(boolean isDarkFont, @FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarDarkIcon(boolean isDarkIcon) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarDarkIcon(boolean isDarkIcon, @FloatRange(from = 0f, to = 1f) float navigationAlpha) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar flymeOSStatusBarFontColor(@ColorRes int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar flymeOSStatusBarFontColor(String flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar flymeOSStatusBarFontColorInt(@ColorInt int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar hideBar(BarHide barHide) {
        if (barHide == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar applySystemFits(boolean applySystemFits) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar fitsSystemWindows(boolean fits) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar fitsSystemWindows(boolean fits, @ColorRes int contentColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar fitsSystemWindowsInt(boolean fits, @ColorInt int contentColor) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar fitsLayoutOverlapEnable(boolean fitsLayoutOverlapEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarView(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarView(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarView(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBar(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBar(View view, boolean statusBarColorTransformEnable) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBar(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBar(@IdRes int viewId, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBar(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBar(@IdRes int viewId, View rootView, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBarMarginTop(@IdRes int viewId) {
        if (mSupportFragment != null && mSupportFragment.getView() != null) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBarMarginTop(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar titleBarMarginTop(View view) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar supportActionBar(boolean isSupportActionBar) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar statusBarColorTransformEnable(boolean statusBarColorTransformEnable) {
        mBarParams.statusBarColorEnabled = statusBarColorTransformEnable;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar reset() {
        mBarParams = new BarParams();
        mFitsStatusBarType = FLAG_FITS_DEFAULT;
        return this;
    }
     ...
     * @return the bar tag
     */
    public SobotImmersionBar addTag(String tag) {
        if (isEmpty(tag)) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar getTag(String tag) {
        if (isEmpty(tag)) {
            throw new IllegalArgumentException("tag不能为空");
        }
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar keyboardEnable(boolean enable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar keyboardEnable(boolean enable, int keyboardMode) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar keyboardMode(int keyboardMode) {
        mBarParams.keyboardMode = keyboardMode;
        return this;
    }
     ...
     */
    public SobotImmersionBar setOnKeyboardListener(@Nullable OnKeyboardListener onKeyboardListener) {
     ...
     */
    public SobotImmersionBar setOnNavigationBarListener(OnNavigationBarListener onNavigationBarListener) {
     ...
     */
    public SobotImmersionBar setOnBarListener(OnBarListener onBarListener) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarEnable(boolean navigationBarEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarWithKitkatEnable(boolean navigationBarWithKitkatEnable) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar navigationBarWithEMUI3Enable(boolean navigationBarWithEMUI3Enable) {
        //是否可以修改emui3系列手机导航栏
        if (OSUtils.isEMUI3_x()) {
     ...
     * @return the immersion bar
     */
    public SobotImmersionBar barEnable(boolean barEnable) {
