...
public class SobotSelectPicAndFileDialog extends Dialog {
    ...
    public SobotSelectPicAndFileDialog(Activity context, View.OnClickListener itemsOnClick) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sobot_take_pic_and_file_pop);
        initView();
    }
    ...
    private void initView() {
        ...
        sobot_choose_file.setOnClickListener(itemsOnClick);
