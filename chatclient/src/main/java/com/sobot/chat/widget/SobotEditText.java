 ...
 * 阿语布局下 从右到左书写
 */
public class SobotEditText extends AppCompatEditText {
    public SobotEditText(Context context) {
        super(context);
        init();
    }

    public SobotEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        try {
            ChatUtils.useLocalePreferredLineHeightForMinimum(this);
